...
1. `char`: This is an 8-bit signed integer type. Since $2^{8} = 256$, `char` can represent character values or small integers in the range $-128$ to $127$, or $0$ to $255$ when unsigned by using `unsigned char`.
3. `int`: This is a 32-bit signed integer. Since $2^{32} = 4,294,967,296$, `int` can represent integer values with a range of $-2,147,483,648$ to $2,147,483,647 \simeq 2.15 \times 10^{9}$, or $0$ to $4,294,967,295$ when unsigned.
5. `long long int` or `long long`: This is a 64-bit signed integer type. Since $2^{64} = 18,446,744,073,709,551,616$, `long long int` provides a range from $-9,223,372,036,854,775,808$ to $9,223,372,036,854,775,807 \simeq 9.22 \times 10^{18}$, or $0$ to $18.45 \times 10^{18}$ when unsigned.
